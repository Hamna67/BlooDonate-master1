...
public class dHistoryConnectivity extends AsyncTask<Void, Void, String> {
    ...
    public dHistoryConnectivity(Context context,String phone, int flag) {
        super();
    ...
    protected String doInBackground(Void... params) {
        ...
        try {
            String link = "http://ec2-13-127-129-16.ap-south-1.compute.amazonaws.com/DHistoryUser.php?phone="+phone+"";;
